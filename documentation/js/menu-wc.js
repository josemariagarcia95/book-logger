...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">books-barcode documentation</a>
                </li>
                ...
                <li class="chapter">
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-1da140412f7407b53e1a98ce45ba8f79"' : 'data-target="#xs-components-links-module-AppModule-1da140412f7407b53e1a98ce45ba8f79"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-1da140412f7407b53e1a98ce45ba8f79"' :
                                            'id="xs-components-links-module-AppModule-1da140412f7407b53e1a98ce45ba8f79"' }>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            <li class="link">
                                <a href="classes/BookDataProvider.html" data-type="entity-link">BookDataProvider</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                <li class="link">
                                    <a href="injectables/BookProviderService.html" data-type="entity-link">BookProviderService</a>
                                </li>
                                <li class="link">
                                    <a href="injectables/GoodReadsProvider.html" data-type="entity-link">GoodReadsProvider</a>
                                </li>
                            </ul>
                        </li>
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            <li class="link">
                                <a href="interfaces/BookData.html" data-type="entity-link">BookData</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
